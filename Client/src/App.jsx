...
import AdminStatisticalChanges from './modules/admin/staticalchanges.jsx';
    ...
    <ErrorBoundary>
      <div style={{ fontSize: fontSizeMap[fontSize] }}>
        <Routes>
          ...
          <Route path="/admin/staticalchanges" element={
            <AdminRoute><AdminStatisticalChanges /></AdminRoute>
          } />

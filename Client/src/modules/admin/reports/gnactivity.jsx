  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <TableCard
        ...
        columns={['#', 'Full Name', 'GN Division', 'District', 'Last Login', 'Days Since Login', 'Status']}
  ...
  return (
    <aside className="w-64 flex-shrink-0 flex flex-col py-6 px-3 gap-2 border-r"
      ...
      <ul className="flex flex-col gap-1 flex-1">
        ...
        <li className="px-4 pt-3 pb-1 text-xs font-extrabold" style={{ color: C.primary }}>Grama Niladhari officer Management</li>
...
export default function AdminGNActivityReports() {
  ...
  return (
    <div className="flex min-h-screen" style={{ background: C.bg, fontFamily: "'Segoe UI',sans-serif" }}>

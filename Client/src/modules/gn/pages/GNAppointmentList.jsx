  ...
  {loading ? (
    ...
    appointments
      ...
      .map((a) => (
        ...
        <div className={`px-4 sm:px-6 py-3 sm:py-4 flex flex-col sm:flex-row items-center justify-between gap-3 border-t ${t.border}`}>
          <p className={`text-[10px] sm:text-xs ${t.subtext}`}>Showing 1-4 of 24 appointments</p>
          <div className="flex items-center gap-1 sm:gap-2">
            <button className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-[#E5A800] text-black text-[10px] sm:text-xs font-bold">1</button>
            <button className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${t.tableRow} ${t.subtext} text-[10px] sm:text-xs`}>2</button>
            <button className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${t.tableRow} ${t.subtext} text-[10px] sm:text-xs`}>3</button>
            <button className={`w-6 h-6 sm:w-7 sm:h-7 rounded-full ${t.tableRow} ${t.subtext} text-[10px] sm:text-xs`}>›</button>
          </div>
        </div>

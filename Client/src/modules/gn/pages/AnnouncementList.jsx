...
const AnnouncementList = ({ gnStatus }) => {
  return (
    <GNLayout gnStatus={gnStatus}>
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        <div className="bg-white rounded-2xl shadow p-5 flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide">Active Notices</p>
        ...
        <div className="bg-white rounded-2xl shadow p-5 flex items-center justify-between">
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-800 mt-1">04</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow p-5 flex items-center justify-between">
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-800 mt-1">1,402</h2>
          </div>
      ...
      <div className="bg-white rounded-2xl shadow overflow-hidden">
            ...
            {announcements.map((item, index) => (
              <tr key={index} className="hover:bg-gray-50">
                <td className="px-6 py-4">
                  ...
                  <p className="text-xs text-gray-400">Section: {item.section}</p>
                </td>
        ...
        <div className="px-6 py-4 flex items-center justify-between border-t">
          <p className="text-xs text-gray-400">Showing 1 to 5 of 24 announcements</p>

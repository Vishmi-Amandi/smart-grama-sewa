...
const CurrentStatus = ({ gnStatus, setGnStatus }) => {
  const [selected, setSelected] = useState(gnStatus);

  const statuses = [
  { label: "Available", icon: <UserCheck size={24} />, color: "text-green-600", selectedBorder: "border-green-500", selectedBg: "bg-green-50" },
  { label: "In Meeting", icon: <CalendarDays size={24} />, color: "text-orange-500", selectedBorder: "border-orange-500", selectedBg: "bg-orange-50" },
  { label: "On Field", icon: <Map size={24} />, color: "text-red-600", selectedBorder: "border-red-500", selectedBg: "bg-red-50" },
];
  ...
  `}>
    {selected.toUpperCase()}
          ...
          <div className="flex-1">
            ...
            {/* Title + Description */}
            <h2 className="text-lg font-bold text-gray-800 mb-1">Availability Toggle</h2>

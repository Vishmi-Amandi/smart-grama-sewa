...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      // Step 1: Set persistence based on "Remember Me"
      if (rememberMe) {
      ...
      // Step 4: Check gn_officers collection for admin role
      const gnOfficerSnap = await getDoc(doc(db, 'gn_officers', user.uid));
      ...
      // Step 5: Check users collection for admin role
      ...
      // Step 6: Document not found in either collection

...
const DynamicFormModal = ({ form, onClose, inputs, setInputs, currentUser, userData, db }) => {
  ...
  const [voterPurpose, setVoterPurpose] = useState('OptionA'); // OptionA = YC Form, OptionB = ER Form
  ...
  const handleFormSubmit = async (e) => {
    ...
    if (form.id === 7) maxSteps = 3; // Step 1: Boundaries, Step 2: Purpose Details (YC or ER), Step 3: Chief Occupant Declaration

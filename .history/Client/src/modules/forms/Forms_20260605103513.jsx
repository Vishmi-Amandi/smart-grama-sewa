  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (user) => {
      if (user) {
        ...
        // --- 🛠️ DEVELOPMENT LOCAL TESTING BYPASS ROUTINE ---
        console.log("No live login session discovered. Deploying local profile bypass dummy account.");
        setCurrentUser({
          uid: "wathsala_local_test_uid",
          email: "wathsala@smartgrama.lk"
        });
        setUserData({
          fullName: "Wathsala Test Account",
          district: "Colombo",
          dsDiv: "Thimbirigasyaya",
          gnDiv: "Hunupitiya (62B)",
          nic: "200012345678"
        });
        
        // Comment out this redirect trigger line so it doesn't force navigate away:
        // navigate('/login'); 
      }

...
const Forms = () => {
  ...
  const formList = [
    ...
    { id: 7, title: "Voter Registration Form", cat: "Applications", desc: "Register for the local voting list" },
    ...
    <div style={S.page}>
      ...
      <div style={S.main}>
        ...
        <div style={S.scrollArea}>
          ...
          {/* Tabs */}
          <div style={{ display: 'flex', borderBottom: '2px solid #e8d5ac', marginBottom: '20px' }}>
            {tabs.map(t => (
            ...
            <button style={{ marginLeft: 'auto', backgroundColor: '#6A2301', color: '#fff', border: 'none', borderRadius: '8px', padding: '8px 16px', fontWeight: 700, cursor: 'pointer' }}>My Forms</button>
          </div>

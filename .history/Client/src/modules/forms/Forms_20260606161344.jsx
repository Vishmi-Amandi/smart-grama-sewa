...
const DynamicFormModal = ({ form, onClose, inputs, setInputs, currentUser, userData, db }) => {
    ...
    if (label === 'age') {
      if (strVal) {
        ...
        if (isNaN(numericAge) || /[^0-9]/.test(strVal)) {
          ...
          msg = 'Age threshold exceeded. Maximum supported lifespan limit on this form is 120.';
        }
      }
    }
  ...
  <input 
    type="text" 
    required 
    onKeyDown={executePhoneKeyPressBlock} // 👈 Changed to match your active phone validation filter function

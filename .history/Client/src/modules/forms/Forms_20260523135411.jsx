...
// --- Multi-Step Dynamic Engine (Supports IDs: 1, 2, 3, 4, 5, 6) ---
                ...
                <>
                  ...
                  <div>
                    ...
                    <select required onChange={e => handleInputChange('valLandType', e.target.value)} value={inputs.valLandType || ''} style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1.5px solid #e8d5ac', boxSizing: 'border-box', backgroundColor: '#fff', outline: 'none' }}>
                      ...
                      <option value="Government (Government Land)">Government Land</option>
                      <option value="Private (Private Deed Land)">Private Deed Land</option>
                      <option value="Temple Property">Temple Property</option>
            ...
            <>
              ...
              {formStep === 2 && (
                <>
                  ...
                  <div>
                    ...
                    <input type="text" required onChange={e => handleInputChange('nicOccupation', e.target.value)} value={inputs.nicOccupation || ''} style={{ width: '100%', padding: '10px', borderRadius: '8px', border: '1.5px solid #e8d5ac', boxSizing: 'border-box', outline: 'none' }} placeholder="E.G. Student / Executive Officer" />
                  </div>
                </>
              )}
              ...
              {formStep === 3 && (
                <>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', fontWeight: 800, color: '#B46A02', textTransform: 'uppercase', marginBottom: '4px' }}>Postal Address (Cage 8.2)</label>
                ...
                <>
                  ...
                  <div style={{ backgroundColor: '#fff', padding: '14px', borderRadius: '12px', border: '1.5px solid #e8d5ac', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '10px' }}>
                      ...
                      <input type="text" required onChange={e => handleInputChange('dfNic', e.target.value)} value={inputs.dfNic || ''} style={{ width: '100%', padding: '8px', borderRadius: '6px', border: '1px solid #e8d5ac', fontSize: '12px' }} placeholder="NIC No" />
                    </div>
                  </div>
                ...
                <>
                  ...
                  <div style={{ backgroundColor: '#fff', padding: '14px', borderRadius: '12px', border: '1.5px solid #e8d5ac', display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', fontSize: '12px', fontWeight: 700 }}>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_blind', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Total Blind
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_spinal', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Spinal Injury
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_cerebral', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Cerebral Palsy
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_deaf_mute', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Deaf &amp; Mute
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_limbs', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Loss of Limbs
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_autism', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Autism
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_intellectual', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Intellectual
                      </label>
                      <label style={{ display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer' }}>
                        <input type="checkbox" onChange={e => handleInputChange('dis_multiple', e.target.checked)} style={{ accentColor: '#6A2301' }} /> Multiple
                      </label>
                    </div>
                  </div>

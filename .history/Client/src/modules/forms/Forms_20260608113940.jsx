      ...
      <div className={`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[1001] w-full max-w-[760px] max-h-[90vh] bg-user-surface dark:bg-user-surface rounded-2xl shadow-2xl overflow-hidden flex flex-col`}>
        ...
        <div className="bg-user-secondary dark:bg-user-secondary p-5 flex justify-between items-center flex-shrink-0">
          <div>
            ...
            <p className="text-xs text-yellow-200">{t('portal_subtitle', 'Official Verification Portal')}</p>
          </div>
              ...
              {formStep === 1 && (
                <>
                  <div className="space-y-4">
                    <h4 className="text-sm font-black text-user-secondary border-b border-user-border pb-2">
  {t('sec_admin_divisions', '1) Administrative Divisions')}
</h4>
          ...
          <div className="flex justify-between mt-4 pt-2 border-t border-user-border">
            ...
            >
              {submitting 
                ...
                : ((form.id === 3 && formStep === 4) || (form.id === 6 && formStep === 4) || (form.id === 7 && formStep === 3) || (form.id === 8 && formStep === 5) || (form.id === 9 && formStep === 4) || (form.id !== 3 && form.id !== 6 && form.id !== 7 && form.id !== 8 && form.id !== 9 && formStep === (form.id === 11 ? 1 : 3))) 
                  ? t('btn_submit', 'Submit') 
                  : t('btn_next', 'Next')
              }
            </button>
...
const tabs = [
  ...
  t('tab_applications', 'Applications'), 
  ...
  return (
    ...
    <h1 className={`font-black text-user-text dark:text-user-text tracking-tight ${
      currentLanguage === 'ta' ? 'text-xl md:text-2xl' : currentLanguage === 'si' ? 'text-2xl md:text-[28px]' : 'text-2xl md:text-3xl'
    }`}>
      {t('nav_forms', 'Forms')}
    </h1>
  </div>

        ...
        <>
          ...
          <div className="fixed top-0 left-0 w-[260px] h-screen bg-[#F5C400] z-50 shadow-2xl flex flex-col py-6 px-4 animate-slide-right">
            ...
            <div className="flex flex-col gap-4 font-bold text-base text-[#3d2a00]">
              ...
              <Link to="/about" className="hover:text-[#6A2301] transition-colors">{t('nav_about', 'About')}</Link>              <a href="#" onClick={() => setMobileMenuOpen(false)} className="px-3 py-2 rounded-lg hover:bg-white/30 transition-colors">News &amp; Notices</a>

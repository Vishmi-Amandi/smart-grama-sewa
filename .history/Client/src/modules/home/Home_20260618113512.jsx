...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="text-xs md:text-sm flex items-center gap-1 md:gap-2 font-bold ml-auto md:ml-0">
          <button onClick={() => changeLanguage('si')} style={{ background: 'none', border: 'none' }}
            className={`cursor-pointer px-1 transition-all text-xs md:text-sm ${i18n.language === 'si' ? 'text-[#6A2301] font-extrabold scale-105' : 'text-inherit opacity-70 font-semibold'}`}>
            සිං
          </button>
          <span className="opacity-30 text-xs">|</span>
          <button onClick={() => changeLanguage('ta')} style={{ background: 'none', border: 'none' }}
            className={`cursor-pointer px-1 transition-all text-xs md:text-sm tracking-tight ${i18n.language === 'ta' ? 'text-[#6A2301] font-extrabold scale-105' : 'text-inherit opacity-70 font-semibold'}`}>
            தமிழ்
          </button>
          <span className="opacity-30 text-xs">|</span>
      ...
      <section
        id="hero"
        className="flex-grow flex items-center px-6 md:px-16 min-h-[calc(100vh-76px)]"
        style={{

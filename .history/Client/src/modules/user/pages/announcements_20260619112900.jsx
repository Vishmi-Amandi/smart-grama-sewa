...
const Announcements = () => {
  ...
  return (
    <div className="user-module min-h-screen flex flex-col font-sans bg-user-background">
                      ...
                      <div className="text-base font-semibold text-user-text-lighter">
                        {activeTab === 'Unread' ? (
                          ...
                          <div className="flex flex-col items-center gap-3">
                            <span>{t('lbl_no_announcements_found', { tab: activeTab === 'All' || activeTab === 'Unread' ? activeTab : t(`tab_${activeTab.toLowerCase()}`) })}</span>
                            {activeTab !== 'All' && (
      ...
      <style>{`
    @keyframes fadeIn { from { opacity: 0; transform: translate(-50%, -45%); } to { opacity: 1; transform: translate(-50%, -50%); } }        @keyframes fadeInUp { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }
